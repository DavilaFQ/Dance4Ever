      ...
      >
        ...
        {!event ? (
          ...
          <main className="flex-1 flex flex-col relative z-10 px-0 pb-0">
            {isDancerOfYearActive ? (
              <div className="py-12 px-4 flex flex-col items-center justify-center text-center bg-zinc-950 text-white z-10 animate-fade-in">
                <div className="animate-pulse">
                  ...
                  <p className="font-display text-2xl leading-none uppercase tracking-wide mt-4 font-black text-neutral-400">Presentación Especial</p>
                </div>
                <div className="flex flex-col items-center justify-center animate-pulse mt-8">
                  <p className="font-display text-lg leading-tight uppercase tracking-wide text-zinc-300">Momento estelar en curso</p>
                  <p className="font-display text-sm leading-tight uppercase tracking-wide mt-1 text-zinc-500">Disfruta del show en el escenario</p>
                </div>
              </div>
            ) : showAwards ? (
