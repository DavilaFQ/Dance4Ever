  ...
  return (
    <div className="fixed inset-0 bg-neutral-900 z-50 flex flex-col">
      <div className="bg-black px-4 py-3 flex items-center justify-between shrink-0">
        <h3 className="font-display text-2xl tracking-widest text-orange-500">ESTADÍSTICAS</h3>
      ...
      <div className="flex-1 min-h-0 p-3 flex flex-col gap-3 text-white">
        ...
        {!startedAt && (
          <button
            ...
            className="shrink-0 bg-orange-500 active:bg-orange-500 text-black font-display text-lg tracking-widest py-3 rounded-lg flex items-center justify-center gap-2"
          >
...
function StatCard({ label, value, sub, children }: {
  ...
  return (
    <div className="bg-neutral-800 rounded-lg p-4 flex-1 min-h-0 flex flex-col justify-center">
      ...
      <p className="font-display text-5xl leading-none mt-3 text-orange-500 truncate">{value}</p>
